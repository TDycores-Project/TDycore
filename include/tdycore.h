...
PETSC_EXTERN PetscErrorCode TDySelectBoundaryConcentrationFn(TDy,const char*,void*);
...
PETSC_EXTERN PetscErrorCode TDySetBoundaryConcentrationFn(TDy,PetscErrorCode(*)(TDy,PetscReal*,PetscReal*,void*),void*);
