...
PETSC_INTERN PetscErrorCode SetupCell2CellConnectivity(TDyVertex*, PetscInt, TDyCell*, TDy_face*, TDySubcell*, PetscInt**);
PETSC_INTERN PetscErrorCode FindFaceIDsOfACellCommonToAVertex(PetscInt, TDy_face*, TDyVertex*, PetscInt,PetscInt[3],PetscInt*);
