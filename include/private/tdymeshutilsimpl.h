...
PETSC_INTERN PetscInt TDyMeshGetNumberOfLocalCells(TDy_mesh*);
PETSC_INTERN PetscInt TDyMeshGetNumberOfLocalFacess(TDy_mesh*);
PETSC_INTERN PetscInt TDyMeshGetNumberOfNonLocalFacess(TDy_mesh*);
PETSC_INTERN PetscInt TDyMeshGetNumberOfNonInternalFacess(TDy_mesh*);
PETSC_INTERN PetscErrorCode AreFacesNeighbors(TDy_face*, PetscInt, PetscInt);
PETSC_INTERN PetscErrorCode TDySubCell_GetIthNuVector(TDy_subcell*, PetscInt, PetscInt, PetscInt, PetscReal*);
PETSC_INTERN PetscErrorCode TDySubCell_GetIthFaceCentroid(TDy_subcell*, PetscInt, PetscInt, PetscInt, PetscReal*);
PETSC_INTERN PetscErrorCode TDySubCell_GetFaceIndexForAFace(TDy_subcell*, PetscInt, PetscInt, PetscInt*);
