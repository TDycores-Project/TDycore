...
PETSC_INTERN PetscErrorCode ExtractPsiSubGmatrix(TDy,PetscInt,PetscInt,PetscInt,PetscReal**);
...
PETSC_INTERN PetscErrorCode TDyMPFAO_SetBoundaryConcentration(TDy,Vec);
