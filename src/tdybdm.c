...
void HdivBasisPrism(const PetscReal *x,PetscReal *B,PetscReal *DF,PetscReal J) {
  TDY_START_FUNCTION_TIMER()
  PetscInt i;
  B[ 0] = 0.;
  B[ 1] = (-x[0]*x[2] + x[0] - x[1]*x[2] + x[1])*0.25;
  B[ 2] = (x[2]*x[2] - 1.)*0.125;
  B[ 3] = (-x[0]*x[2] + x[0] - x[1]*x[2] + x[1])*0.25;
  B[ 4] = 0.;
  B[ 5] = (x[2]*x[2] - 1.)*0.125;
  B[ 6] = (x[0]*x[0] + x[0]*x[1] + x[0] + x[1])*0.0833333333333333;
  B[ 7] = (x[0]*x[1] + x[0] + x[1]*x[1] + x[1])*0.0833333333333333;
  B[ 8] = (-x[0]*x[2] + x[0] - x[1]*x[2] + x[1])*0.25;
  B[ 9] = (-x[0]*x[2] + x[0] - x[2] + 1.)*0.25;
  B[10] = (x[0]*x[2] - x[0] + x[2] - 1.)*0.25;
  B[11] = (x[2]*x[2] - 1.)*0.125;
  B[12] = (-x[0]*x[2] + x[0] - x[2] + 1.)*0.353553390593274;
  B[13] = 0.;
  B[14] = (x[2]*x[2] - 1.)*0.176776695296637;
  B[15] = (1. - x[0]*x[0])*0.0833333333333333;
  B[16] = (-x[0]*x[1] - x[0] - x[1] - 1.)*0.0833333333333333;
  B[17] = (x[0]*x[2] - x[0] + x[2] - 1.)*0.25;
  B[18] = (x[1]*x[2] - x[1] + x[2] - 1.)*0.25;
  B[19] = (-x[1]*x[2] + x[1] - x[2] + 1.)*0.25;
  B[20] = (x[2]*x[2] - 1.)*0.125;
  B[21] = 0.;
  B[22] = (-x[1]*x[2] + x[1] - x[2] + 1.)*0.353553390593274;
  B[23] = (x[2]*x[2] - 1.)*0.176776695296637;
  B[24] = (-x[0]*x[1] - x[0] - x[1] - 1.)*0.0833333333333333;
  B[25] = (1. - x[1]*x[1])*0.0833333333333333;
  B[26] = (x[1]*x[2] - x[1] + x[2] - 1.)*0.25;
  B[27] = 0.;
  B[28] = (x[0]*x[2] + x[0] + x[1]*x[2] + x[1])*0.25;
  B[29] = (1 - x[2]*x[2])*0.125;
  B[30] = (x[0]*x[2] + x[0] + x[1]*x[2] + x[1])*0.25;
  B[31] = 0.;
  B[32] = (1. - x[2]*x[2])*0.125;
  B[33] = (x[0]*x[0] + x[0]*x[1] + x[0] + x[1])*0.0833333333333333;
  B[34] = (x[0]*x[1] + x[0] + x[1]*x[1] + x[1])*0.0833333333333333;
  B[35] = (-x[0]*x[2] - x[0] - x[1]*x[2] - x[1])*0.25;
  B[36] = (x[0]*x[2] + x[0] + x[2] + 1.)*0.25;
  B[37] = (-x[0]*x[2] - x[0] - x[2] - 1.)*0.25;
  B[38] = (1. - x[2]*x[2])*0.125;
  B[39] = (x[0]*x[2] + x[0] + x[2] + 1.)*0.353553390593274;
  B[40] = 0.;
  B[41] = (1. - x[2]*x[2])*0.176776695296637;
  B[42] = (1. - x[0]*x[0])*0.0833333333333333;
  B[43] = (-x[0]*x[1] - x[0] - x[1] - 1.)*0.0833333333333333;
  B[44] = (x[0]*x[2] + x[0] + x[2] + 1.)*0.25;
  B[45] = (-x[1]*x[2] - x[1] - x[2] - 1.)*0.25;
  B[46] = (x[1]*x[2] + x[1] + x[2] + 1.)*0.25;
  B[47] = (1. - x[2]*x[2])*0.125;
  B[48] = 0.;
  B[49] = (x[1]*x[2] + x[1] + x[2] + 1.)*0.353553390593274;
  B[50] = (1. - x[2]*x[2])*0.176776695296637;
  B[51] = (-x[0]*x[1] - x[0] - x[1] - 1.)*0.0833333333333333;
  B[52] = (1. - x[1]*x[1])*0.0833333333333333;
  B[53] = (x[1]*x[2] + x[1] + x[2] + 1.)*0.25;
  for(i=0;i<18;i++) TDyPiola(&(B[3*i]),DF,J,3);
  TDY_STOP_FUNCTION_TIMER()
}
